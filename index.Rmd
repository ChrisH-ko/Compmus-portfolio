...
sonata_9 <- timbre_analysis[[3]]
sonata_10 <- timbre_analysis[[2]]
...
plot_grid(plotlist = list(cep_1, cep_9), ncol = 1)
```
...
```{r}
selfsim_chroma_1 <- self_similarity(sonata_9, chroma=TRUE)
selfsim_timbre_1 <- self_similarity(sonata_9, chroma=FALSE)
