...
all_recordings |>
  ...
  geom_rug() +
  theme(panel.background = element_rect(fill = "#ccdbc8",
                                colour = "#ccdbc8")) +
  #theme_minimal() +
  labs(
    x = "Mean Tempo (bpm)",
...
As expected, different pianist show quite a different spread when it comes to their tempo and tempo variance throughout their recordings. Maria Lettberg's recordings seem to all be quite consistent, while Vladimir Ashkenazy takes a lot more liberty when it comes to tempo. Interestingl
